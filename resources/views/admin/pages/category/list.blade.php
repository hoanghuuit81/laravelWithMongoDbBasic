                                        ...
                                        <tr class="tr-shadow">
                                            ...
                                            <td>
                                                <div class="table-data-feature">
                                                    ...
                                                    <a href="{{ route('category.edit', $item->_id) }}" class="item"
                                                        data-toggle="tooltip" data-placement="top" title="Chi tiết">
                                                        <i class="zmdi zmdi-edit"></i>
                                                    </a>
                                                    
                                                        <a class="item" href="{{ route('category.delete', $item->_id) }}"
                                                            onclick="return confirm('Hành động này đồng nghĩa với việc sẽ xóa tất cả sản phẩm thuộc danh mục này')"
